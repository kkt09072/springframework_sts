...
<head>
<meta charset="UTF-8">
<title>학생 컬렉션 전송 - JSON으로 받기</title>
<script src="https://code.jquery.com/jquery-latest.js"></script>
</head>
<body>
	<!-- src/main/webapp/WEB-INF/views/api/api6.jsp 를 src/main/webapp/WEB-INF/views/api/api16.jsp 이름으로 복사하여 편집 -->
	<div class="form">
	...
	$(document).ready(function(){
		$("#btn1").click(function(){
			...
			var std = [student, student, student];
